    ...
    <div className="py-16 bg-gray-100 dark:bg-gray-950">
      ...
      <div className="w-[80%] mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
                  ...
                  {socialLinks.map((link) => {
                    return (
                      <a
                        ...
                        key={link.label}
                        target="_blank"
                        className="w-12 h-12 rounded-xl bg-white dark:bg-gray-800 flex items-center justify-center text-muted-foreground hover:text-blue-500 shadow-md transition-colors"
                      >
          ...
          {/* Contact Form */}
          <form className="bg-white dark:bg-gray-800 rounded-2xl px-8 pt-8 pb-2 space-y-6 shadow-md">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                rows={5}
                required
                className="bg-gray-100 dark:bg-gray-900 min-h-40"
              />
            </div>
